...
<div class="btn-group">
    <a href="subcont23january.php" class="btn btn-warning mr-1">Januari</a>
    <br>
        <a href="subcont23february.php" class="btn btn-warning mr-1">Februari</a>
        <br>
        <a href="subcont23maret.php" class="btn btn-warning mr-1">Maret</a>
        <br>
        <a href="subcont23april.php" class="btn btn-warning mr-1">April</a>
        <br>
        <a href="subcont23mei.php" class="btn btn-warning mr-1">Mei</a>
        <br>
        <a href="subcont23juni.php" class="btn btn-warning mr-1">Juni</a>
        <br>
        <a href="subcont23juli.php" class="btn btn-warning mr-1">Juli</a>
        <br>
        <a href="subcont23agustus.php" class="btn btn-warning mr-1">Agustus</a>
        <br>
        <a href="subcont23september.php" class="btn btn-warning mr-1">September</a>
        <br>
        <a href="subcont23oktober.php" class="btn btn-warning mr-1">Oktober</a>
        <br>
        <a href="subcont23november.php" class="btn btn-warning mr-1">November</a>
        <br>
        <a href="subcont23desember.php" class="btn btn-warning mr-1">Desember</a>
    </div>
