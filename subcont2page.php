...
<nav class="navbar navbar-expand-lg py-3 navbar-dark bg-dark shadow-sm">
    ...
    <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <li><a class="btn btn-success btn-sm" href="subcont_download_page.php">Download Data</a></li>&nbsp;
...
<div class="btn-group">
    <a href="subcont2january.php" class="btn btn-warning mr-1">Januari</a>
    <br>
        <a href="subcont2february.php" class="btn btn-warning mr-1">Februari</a>
        <br>
        <a href="subcont2maret.php" class="btn btn-warning mr-1">Maret</a>
        <br>
        <a href="subcont2april.php" class="btn btn-warning mr-1">April</a>
        <br>
        <a href="subcont2mei.php" class="btn btn-warning mr-1">Mei</a>
        <br>
        <a href="subcont2juni.php" class="btn btn-warning mr-1">Juni</a>
        <br>
        <a href="subcont2juli.php" class="btn btn-warning mr-1">Juli</a>
        <br>
        <a href="subcont2agustus.php" class="btn btn-warning mr-1">Agustus</a>
        <br>
        <a href="subcont2september.php" class="btn btn-warning mr-1">September</a>
        <br>
        <a href="subcont2oktober.php" class="btn btn-warning mr-1">Oktober</a>
        <br>
        <a href="subcont2november.php" class="btn btn-warning mr-1">November</a>
        <br>
        <a href="subcont2desember.php" class="btn btn-warning mr-1">Desember</a>
    </div>
