...
<script src="bootstrap-table-resizeable.js"></script>
    <title>Subcont Download Page 2 List</title>
</head>
<body>
...
<hr>
    ...
    <div class="container">
        <div class="row">
            <?php $ambil = $koneksi->query("SELECT * FROM subcont2_pg2"); ?>
            <?php while($subcontpg2 = $ambil->fetch_assoc()) { ?>
            <div class="col-12">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            <td><?php echo $subcontpg2['id']; ?></td>
                            <td><?php echo date('l, d-m-Y'); ?></td>
                            <td><a href="update_subcont_result_pg2.php?id=<?php echo $subcontpg2['id']; ?>" class="btn btn-success"><i class="fa fa-download"></i></a></td>
                        </tr>
                    </tbody>
                </table>
            </div>
