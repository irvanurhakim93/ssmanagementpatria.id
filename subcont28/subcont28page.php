...
<div class="btn-group">
    <a href="subcont28january.php" class="btn btn-warning mr-1">Januari</a>
    <br>
        <a href="subcont28february.php" class="btn btn-warning mr-1">Februari</a>
        <br>
        <a href="subcont28maret.php" class="btn btn-warning mr-1">Maret</a>
        <br>
        <a href="subcont28april.php" class="btn btn-warning mr-1">April</a>
        <br>
        <a href="subcont28mei.php" class="btn btn-warning mr-1">Mei</a>
        <br>
        <a href="subcont28juni.php" class="btn btn-warning mr-1">Juni</a>
        <br>
        <a href="subcont28juli.php" class="btn btn-warning mr-1">Juli</a>
        <br>
        <a href="subcont28agustus.php" class="btn btn-warning mr-1">Agustus</a>
        <br>
        <a href="subcont28september.php" class="btn btn-warning mr-1">September</a>
        <br>
        <a href="subcont28oktober.php" class="btn btn-warning mr-1">Oktober</a>
        <br>
        <a href="subcont28november.php" class="btn btn-warning mr-1">November</a>
        <br>
        <a href="subcont28desember.php" class="btn btn-warning mr-1">Desember</a>
    </div>
