...
<div class="btn-group">
    <a href="subcont17january.php" class="btn btn-warning mr-1">Januari</a>
    <br>
        <a href="subcont17february.php" class="btn btn-warning mr-1">Februari</a>
        <br>
        <a href="subcont17maret.php" class="btn btn-warning mr-1">Maret</a>
        <br>
        <a href="subcont17april.php" class="btn btn-warning mr-1">April</a>
        <br>
        <a href="subcont17mei.php" class="btn btn-warning mr-1">Mei</a>
        <br>
        <a href="subcont17juni.php" class="btn btn-warning mr-1">Juni</a>
        <br>
        <a href="subcont17juli.php" class="btn btn-warning mr-1">Juli</a>
        <br>
        <a href="subcont17agustus.php" class="btn btn-warning mr-1">Agustus</a>
        <br>
        <a href="subcont17september.php" class="btn btn-warning mr-1">September</a>
        <br>
        <a href="subcont17oktober.php" class="btn btn-warning mr-1">Oktober</a>
        <br>
        <a href="subcont17november.php" class="btn btn-warning mr-1">November</a>
        <br>
        <a href="subcont17desember.php" class="btn btn-warning mr-1">Desember</a>
    </div>
