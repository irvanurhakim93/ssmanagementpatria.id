...
$query =    "INSERT INTO subcont (
            ...
            if(!$result){
                ...
                window.location = 'update_data_subcont_pg2.php';
                </script>";
            }
...
$otherfacilty = $_POST['input-other-facilities-and-specs'];

$query = "INSERT INTO subcont(milling_machine,milling_machine_2,milling_machine_3,milling_machine_4,milling_machine_5,milling_machine_6,milling_machine_7,milling_machine_8,milling_machine_9,milling_machine_10,milling_machine_max_drilling,milling_machine_max_drilling_2,milling_machine_max_drilling_3,milling_machine_max_drilling_4,milling_machine_max_drilling_5,blasting_booth,painting_booth,oven_force_dryer,compressor_capacity,other_facilities) 
VALUES ('$maxworkpiecelength','$maxworkpiecelength2','$maxworkpiecelength3','$maxworkpiecelength4','$maxworkpiecelength5','$millingmachine','$millingmachine2','$millingmachine3','$millingmachine4','$maxdrillingdiameter','$maxdrillingdiameter2','$maxdrillingdiameter3','$maxdrillingdiameter4','$maxdrillingdiameter5','$blastingbooth','$paintingbooth','$ovenforcedryer','$compressorcapacity','$otherfacilty')";
$result = mysqli_query($koneksi,$query);
    ...
    " - ".mysqli_error($koneksi));
     ...
     echo "<script>alert(\"Data successfully added\");
     window.location = 'subcont_page.php';
     </script>";
 }
