...
<div class="btn-group">
    <a href="subcont18january.php" class="btn btn-warning mr-1">Januari</a>
    <br>
        <a href="subcont18february.php" class="btn btn-warning mr-1">Februari</a>
        <br>
        <a href="subcont18maret.php" class="btn btn-warning mr-1">Maret</a>
        <br>
        <a href="subcont18april.php" class="btn btn-warning mr-1">April</a>
        <br>
        <a href="subcont18mei.php" class="btn btn-warning mr-1">Mei</a>
        <br>
        <a href="subcont18juni.php" class="btn btn-warning mr-1">Juni</a>
        <br>
        <a href="subcont18juli.php" class="btn btn-warning mr-1">Juli</a>
        <br>
        <a href="subcont18agustus.php" class="btn btn-warning mr-1">Agustus</a>
        <br>
        <a href="subcont18september.php" class="btn btn-warning mr-1">September</a>
        <br>
        <a href="subcont18oktober.php" class="btn btn-warning mr-1">Oktober</a>
        <br>
        <a href="subcont18november.php" class="btn btn-warning mr-1">November</a>
        <br>
        <a href="subcont18desember.php" class="btn btn-warning mr-1">Desember</a>
    </div>
