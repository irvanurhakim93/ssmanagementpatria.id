...
<div class="btn-group">
    <a href="subcont21january.php" class="btn btn-warning mr-1">Januari</a>
    <br>
        <a href="subcont21february.php" class="btn btn-warning mr-1">Februari</a>
        <br>
        <a href="subcont21maret.php" class="btn btn-warning mr-1">Maret</a>
        <br>
        <a href="subcont21april.php" class="btn btn-warning mr-1">April</a>
        <br>
        <a href="subcont21mei.php" class="btn btn-warning mr-1">Mei</a>
        <br>
        <a href="subcont21juni.php" class="btn btn-warning mr-1">Juni</a>
        <br>
        <a href="subcont21juli.php" class="btn btn-warning mr-1">Juli</a>
        <br>
        <a href="subcont21agustus.php" class="btn btn-warning mr-1">Agustus</a>
        <br>
        <a href="subcont21september.php" class="btn btn-warning mr-1">September</a>
        <br>
        <a href="subcont21oktober.php" class="btn btn-warning mr-1">Oktober</a>
        <br>
        <a href="subcont21november.php" class="btn btn-warning mr-1">November</a>
        <br>
        <a href="subcont21desember.php" class="btn btn-warning mr-1">Desember</a>
    </div>
