...
<hr>
    ...
    <div class="container">
        <div class="row">
            <?php $ambil = $koneksi->query("SELECT * FROM subcont_pg1"); ?>
            <?php while($subcontpg1 = $ambil->fetch_assoc()) { ?>
            <div class="col-12">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            <td><?php echo $subcontpg1['id']; ?></td>
                            <td><?php echo $subcontpg1['nama_perusahaan']; ?></td>
                            <td><a href="update_subcont_result_pg1.php?id=<?php echo $subcontpg1['id']; ?>" class="btn btn-success"><i class="fa fa-download"></i></a></td>
                        </tr>
                    </tbody>
                </table>
            </div>
