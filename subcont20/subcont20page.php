...
<div class="btn-group">
    <a href="subcont20january.php" class="btn btn-warning mr-1">Januari</a>
    <br>
        <a href="subcont20february.php" class="btn btn-warning mr-1">Februari</a>
        <br>
        <a href="subcont20maret.php" class="btn btn-warning mr-1">Maret</a>
        <br>
        <a href="subcont20april.php" class="btn btn-warning mr-1">April</a>
        <br>
        <a href="subcont20mei.php" class="btn btn-warning mr-1">Mei</a>
        <br>
        <a href="subcont20juni.php" class="btn btn-warning mr-1">Juni</a>
        <br>
        <a href="subcont20juli.php" class="btn btn-warning mr-1">Juli</a>
        <br>
        <a href="subcont20agustus.php" class="btn btn-warning mr-1">Agustus</a>
        <br>
        <a href="subcont20september.php" class="btn btn-warning mr-1">September</a>
        <br>
        <a href="subcont20oktober.php" class="btn btn-warning mr-1">Oktober</a>
        <br>
        <a href="subcont20november.php" class="btn btn-warning mr-1">November</a>
        <br>
        <a href="subcont20desember.php" class="btn btn-warning mr-1">Desember</a>
    </div>
