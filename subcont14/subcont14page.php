...
<div class="btn-group">
    <a href="subcont14january.php" class="btn btn-warning mr-1">Januari</a>
    <br>
        <a href="subcont14february.php" class="btn btn-warning mr-1">Februari</a>
        <br>
        <a href="subcont14maret.php" class="btn btn-warning mr-1">Maret</a>
        <br>
        <a href="subcont14april.php" class="btn btn-warning mr-1">April</a>
        <br>
        <a href="subcont14mei.php" class="btn btn-warning mr-1">Mei</a>
        <br>
        <a href="subcont14juni.php" class="btn btn-warning mr-1">Juni</a>
        <br>
        <a href="subcont14juli.php" class="btn btn-warning mr-1">Juli</a>
        <br>
        <a href="subcont14agustus.php" class="btn btn-warning mr-1">Agustus</a>
        <br>
        <a href="subcont14september.php" class="btn btn-warning mr-1">September</a>
        <br>
        <a href="subcont14oktober.php" class="btn btn-warning mr-1">Oktober</a>
        <br>
        <a href="subcont14november.php" class="btn btn-warning mr-1">November</a>
        <br>
        <a href="subcont14desember.php" class="btn btn-warning mr-1">Desember</a>
    </div>
