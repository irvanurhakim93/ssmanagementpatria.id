...
<div class="btn-group">
    <a href="subcont30january.php" class="btn btn-warning mr-1">Januari</a>
    <br>
        <a href="subcont30february.php" class="btn btn-warning mr-1">Februari</a>
        <br>
        <a href="subcont30maret.php" class="btn btn-warning mr-1">Maret</a>
        <br>
        <a href="subcont30april.php" class="btn btn-warning mr-1">April</a>
        <br>
        <a href="subcont30mei.php" class="btn btn-warning mr-1">Mei</a>
        <br>
        <a href="subcont30juni.php" class="btn btn-warning mr-1">Juni</a>
        <br>
        <a href="subcont30juli.php" class="btn btn-warning mr-1">Juli</a>
        <br>
        <a href="subcont30agustus.php" class="btn btn-warning mr-1">Agustus</a>
        <br>
        <a href="subcont30september.php" class="btn btn-warning mr-1">September</a>
        <br>
        <a href="subcont30oktober.php" class="btn btn-warning mr-1">Oktober</a>
        <br>
        <a href="subcont30november.php" class="btn btn-warning mr-1">November</a>
        <br>
        <a href="subcont30desember.php" class="btn btn-warning mr-1">Desember</a>
    </div>
