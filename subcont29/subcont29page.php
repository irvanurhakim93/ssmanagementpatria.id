...
<div class="btn-group">
    <a href="subcont29january.php" class="btn btn-warning mr-1">Januari</a>
    <br>
        <a href="subcont29february.php" class="btn btn-warning mr-1">Februari</a>
        <br>
        <a href="subcont29maret.php" class="btn btn-warning mr-1">Maret</a>
        <br>
        <a href="subcont29april.php" class="btn btn-warning mr-1">April</a>
        <br>
        <a href="subcont29mei.php" class="btn btn-warning mr-1">Mei</a>
        <br>
        <a href="subcont29juni.php" class="btn btn-warning mr-1">Juni</a>
        <br>
        <a href="subcont29juli.php" class="btn btn-warning mr-1">Juli</a>
        <br>
        <a href="subcont29agustus.php" class="btn btn-warning mr-1">Agustus</a>
        <br>
        <a href="subcont29september.php" class="btn btn-warning mr-1">September</a>
        <br>
        <a href="subcont29oktober.php" class="btn btn-warning mr-1">Oktober</a>
        <br>
        <a href="subcont29november.php" class="btn btn-warning mr-1">November</a>
        <br>
        <a href="subcont29desember.php" class="btn btn-warning mr-1">Desember</a>
    </div>
