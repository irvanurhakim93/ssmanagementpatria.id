...
$query = "INSERT INTO delivery (Po_No,No_Subcont,Nama_Subcont,PN,Product_Item_No,Po_Qty,Statuss) VALUES ('$pono', '$nosubcont','$namasubcont', '$pn','$productitemno', '$qty', '$status')";
