...
<div class="btn-group">
    <a href="subcont27january.php" class="btn btn-warning mr-1">Januari</a>
    <br>
        <a href="subcont27february.php" class="btn btn-warning mr-1">Februari</a>
        <br>
        <a href="subcont27maret.php" class="btn btn-warning mr-1">Maret</a>
        <br>
        <a href="subcont27april.php" class="btn btn-warning mr-1">April</a>
        <br>
        <a href="subcont27mei.php" class="btn btn-warning mr-1">Mei</a>
        <br>
        <a href="subcont27juni.php" class="btn btn-warning mr-1">Juni</a>
        <br>
        <a href="subcont27juli.php" class="btn btn-warning mr-1">Juli</a>
        <br>
        <a href="subcont27agustus.php" class="btn btn-warning mr-1">Agustus</a>
        <br>
        <a href="subcont27september.php" class="btn btn-warning mr-1">September</a>
        <br>
        <a href="subcont27oktober.php" class="btn btn-warning mr-1">Oktober</a>
        <br>
        <a href="subcont27november.php" class="btn btn-warning mr-1">November</a>
        <br>
        <a href="subcont27desember.php" class="btn btn-warning mr-1">Desember</a>
    </div>
