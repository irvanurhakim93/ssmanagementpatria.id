...
<div class="btn-group">
    <a href="subcont19january.php" class="btn btn-warning mr-1">Januari</a>
    <br>
        <a href="subcont19february.php" class="btn btn-warning mr-1">Februari</a>
        <br>
        <a href="subcont19maret.php" class="btn btn-warning mr-1">Maret</a>
        <br>
        <a href="subcont19april.php" class="btn btn-warning mr-1">April</a>
        <br>
        <a href="subcont19mei.php" class="btn btn-warning mr-1">Mei</a>
        <br>
        <a href="subcont19juni.php" class="btn btn-warning mr-1">Juni</a>
        <br>
        <a href="subcont19juli.php" class="btn btn-warning mr-1">Juli</a>
        <br>
        <a href="subcont19agustus.php" class="btn btn-warning mr-1">Agustus</a>
        <br>
        <a href="subcont19september.php" class="btn btn-warning mr-1">September</a>
        <br>
        <a href="subcont19oktober.php" class="btn btn-warning mr-1">Oktober</a>
        <br>
        <a href="subcont19november.php" class="btn btn-warning mr-1">November</a>
        <br>
        <a href="subcont19desember.php" class="btn btn-warning mr-1">Desember</a>
    </div>
