...
<thead class="thead bg-success">
    ...
    <tbody>
        ...
        $query = mysqli_query($koneksi,"SELECT * FROM subcont21_delivery WHERE Po_No like '%".$keyword."%' OR Nama_Subcont like '%".$keyword."%' OR PN like '%".$keyword."%' OR Product_Item_No like '%".$keyword."%' OR Statuss like '%".$keyword."%' ORDER BY id_delivery DESC");
