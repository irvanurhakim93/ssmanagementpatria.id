...
<div class="btn-group">
    <a href="subcont10january.php" class="btn btn-warning mr-1">Januari</a>
    <br>
        <a href="subcont10february.php" class="btn btn-warning mr-1">Februari</a>
        <br>
        <a href="subcont10maret.php" class="btn btn-warning mr-1">Maret</a>
        <br>
        <a href="subcont10april.php" class="btn btn-warning mr-1">April</a>
        <br>
        <a href="subcont10mei.php" class="btn btn-warning mr-1">Mei</a>
        <br>
        <a href="subcont10juni.php" class="btn btn-warning mr-1">Juni</a>
        <br>
        <a href="subcont10juli.php" class="btn btn-warning mr-1">Juli</a>
        <br>
        <a href="subcont10agustus.php" class="btn btn-warning mr-1">Agustus</a>
        <br>
        <a href="subcont10september.php" class="btn btn-warning mr-1">September</a>
        <br>
        <a href="subcont10oktober.php" class="btn btn-warning mr-1">Oktober</a>
        <br>
        <a href="subcont10november.php" class="btn btn-warning mr-1">November</a>
        <br>
        <a href="subcont10desember.php" class="btn btn-warning mr-1">Desember</a>
    </div>
