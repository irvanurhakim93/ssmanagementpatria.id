...
<div class="btn-group">
    <a href="subcont22january.php" class="btn btn-warning mr-1">Januari</a>
    <br>
        <a href="subcont22february.php" class="btn btn-warning mr-1">Februari</a>
        <br>
        <a href="subcont22maret.php" class="btn btn-warning mr-1">Maret</a>
        <br>
        <a href="subcont22april.php" class="btn btn-warning mr-1">April</a>
        <br>
        <a href="subcont22mei.php" class="btn btn-warning mr-1">Mei</a>
        <br>
        <a href="subcont22juni.php" class="btn btn-warning mr-1">Juni</a>
        <br>
        <a href="subcont22juli.php" class="btn btn-warning mr-1">Juli</a>
        <br>
        <a href="subcont22agustus.php" class="btn btn-warning mr-1">Agustus</a>
        <br>
        <a href="subcont22september.php" class="btn btn-warning mr-1">September</a>
        <br>
        <a href="subcont22oktober.php" class="btn btn-warning mr-1">Oktober</a>
        <br>
        <a href="subcont22november.php" class="btn btn-warning mr-1">November</a>
        <br>
        <a href="subcont22desember.php" class="btn btn-warning mr-1">Desember</a>
    </div>
