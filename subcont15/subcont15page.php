...
<div class="btn-group">
    <a href="subcont15january.php" class="btn btn-warning mr-1">Januari</a>
    <br>
        <a href="subcont15february.php" class="btn btn-warning mr-1">Februari</a>
        <br>
        <a href="subcont15maret.php" class="btn btn-warning mr-1">Maret</a>
        <br>
        <a href="subcont15april.php" class="btn btn-warning mr-1">April</a>
        <br>
        <a href="subcont15mei.php" class="btn btn-warning mr-1">Mei</a>
        <br>
        <a href="subcont15juni.php" class="btn btn-warning mr-1">Juni</a>
        <br>
        <a href="subcont15juli.php" class="btn btn-warning mr-1">Juli</a>
        <br>
        <a href="subcont15agustus.php" class="btn btn-warning mr-1">Agustus</a>
        <br>
        <a href="subcont15september.php" class="btn btn-warning mr-1">September</a>
        <br>
        <a href="subcont15oktober.php" class="btn btn-warning mr-1">Oktober</a>
        <br>
        <a href="subcont15november.php" class="btn btn-warning mr-1">November</a>
        <br>
        <a href="subcont15desember.php" class="btn btn-warning mr-1">Desember</a>
    </div>
