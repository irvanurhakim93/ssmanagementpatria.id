...
<?php $ambil = $koneksi->query("SELECT * FROM subcont4_pg1 WHERE id='$id_page'");?>
<?php while($perdata = $ambil->fetch_assoc()) {?>
      ...
      <div class="form-inline">
        ...
        <div class="form-inline">
          ...
          <a href="update_subcont_result_excel_pg1.php" class="btn btn-success d-print-none">Konversi Ke Excel</a>
        </div>
