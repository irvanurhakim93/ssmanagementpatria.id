...
$welderpermanent = $_POST['input-welder-permanent'];
$weldercontract = $_POST['input-welder-contract'];
$welderdaily = $_POST['input-welder-daily'];
$welderwholesale = $_POST['input-welder-daily'];
$assemblerpermanent = $_POST['input-assembler-permanent'];
$assemblercontract = $_POST['input-assembler-contract'];
$assemblerdaily = $_POST['input-assembler-daily'];
$assemblerwholesale = $_POST['input-assembler-wholesale'];
$painterpermanent = $_POST['input-painter-permanent'];
$paintercontract = $_POST['input-painter-contract'];
$painterdaily = $_POST['input-painter-daily'];
$painterwholesale = $_POST['input-painter-wholesale'];
$qcpermanent = $_POST['input-qc-permanent'];
$qccontract = $_POST['input-qc-contract'];
$qcdaily = $_POST['input-qc-daily'];
$qcwholesale = $_POST['input-qc-wholesale'];
$machiningpermanent = $_POST['input-machining-permanent'];
$machiningcontract = $_POST['input-machining-contract'];
$machiningdaily = $_POST['input-machining-daily'];
$machiningwholesale = $_POST['input-machining-wholesale'];
$engineerpermanent = $_POST['input-engineer-permanent'];
$engineercontract = $_POST['input-engineer-contract'];
$engineerdaily = $_POST['input-engineer-daily'];
$engineerwholesale = $_POST['input-engineer-permanent'];
...
$query = "INSERT INTO subcont2_pg1 (
  nama_perusahaan,
  alamat_kantor,
  telepon_kantor,
  fax_kantor,
  ...
  painter_daily, 
  painter_wholesale, 
  qc_inspector_permanent, 
  qc_inspector_contract,
  qc_inspector_daily, 
  qc_inspector_wholesale, 
  machining_forming_permanent, 
  machining_forming_contract, 
  machining_forming_daily, 
  machining_forming_wholesale, 
  engineer_permanent, 
  engineer_contract, 
  engineer_daily, 
  engineer_wholesale, 
  ...
  other_facilities) 
        ...
        '$otherfacility')";
            ...
            if(!$result){
                ...
                window.location = 'subcont_page_1_download_list.php';
                </script>";
            }
