...
<nav class="navbar navbar-expand-lg py-3 navbar-dark bg-dark shadow-sm">
    ...
    <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <li><a class="btn btn-success btn-sm" href="subcont_download_list.php">Download Data</a></li>&nbsp;
...
<div class="btn-group">
    <a href="subcont4january.php" class="btn btn-warning mr-1">Januari</a>
    <br>
        <a href="subcont4february.php" class="btn btn-warning mr-1">Februari</a>
        <br>
        <a href="subcont4maret.php" class="btn btn-warning mr-1">Maret</a>
        <br>
        <a href="subcont4april.php" class="btn btn-warning mr-1">April</a>
        <br>
        <a href="subcont4mei.php" class="btn btn-warning mr-1">Mei</a>
        <br>
        <a href="subcont4juni.php" class="btn btn-warning mr-1">Juni</a>
        <br>
        <a href="subcont4juli.php" class="btn btn-warning mr-1">Juli</a>
        <br>
        <a href="subcont4agustus.php" class="btn btn-warning mr-1">Agustus</a>
        <br>
        <a href="subcont4september.php" class="btn btn-warning mr-1">September</a>
        <br>
        <a href="subcont4oktober.php" class="btn btn-warning mr-1">Oktober</a>
        <br>
        <a href="subcont4november.php" class="btn btn-warning mr-1">November</a>
        <br>
        <a href="subcont4desember.php" class="btn btn-warning mr-1">Desember</a>
    </div>
