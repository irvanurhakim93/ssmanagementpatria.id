...
<div class="btn-group">
    <a href="subcont16january.php" class="btn btn-warning mr-1">Januari</a>
    <br>
        <a href="subcont16february.php" class="btn btn-warning mr-1">Februari</a>
        <br>
        <a href="subcont16maret.php" class="btn btn-warning mr-1">Maret</a>
        <br>
        <a href="subcont16april.php" class="btn btn-warning mr-1">April</a>
        <br>
        <a href="subcont16mei.php" class="btn btn-warning mr-1">Mei</a>
        <br>
        <a href="subcont16juni.php" class="btn btn-warning mr-1">Juni</a>
        <br>
        <a href="subcont16juli.php" class="btn btn-warning mr-1">Juli</a>
        <br>
        <a href="subcont16agustus.php" class="btn btn-warning mr-1">Agustus</a>
        <br>
        <a href="subcont16september.php" class="btn btn-warning mr-1">September</a>
        <br>
        <a href="subcont16oktober.php" class="btn btn-warning mr-1">Oktober</a>
        <br>
        <a href="subcont16november.php" class="btn btn-warning mr-1">November</a>
        <br>
        <a href="subcont16desember.php" class="btn btn-warning mr-1">Desember</a>
    </div>
