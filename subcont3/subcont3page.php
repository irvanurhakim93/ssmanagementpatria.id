...
<div class="btn-group">
    <a href="subcont3january.php" class="btn btn-warning mr-1">Januari</a>
    <br>
        <a href="subcont3february.php" class="btn btn-warning mr-1">Februari</a>
        <br>
        <a href="subcont3maret.php" class="btn btn-warning mr-1">Maret</a>
        <br>
        <a href="subcont3april.php" class="btn btn-warning mr-1">April</a>
        <br>
        <a href="subcont3mei.php" class="btn btn-warning mr-1">Mei</a>
        <br>
        <a href="subcont3juni.php" class="btn btn-warning mr-1">Juni</a>
        <br>
        <a href="subcont3juli.php" class="btn btn-warning mr-1">Juli</a>
        <br>
        <a href="subcont3agustus.php" class="btn btn-warning mr-1">Agustus</a>
        <br>
        <a href="subcont3september.php" class="btn btn-warning mr-1">September</a>
        <br>
        <a href="subcont3oktober.php" class="btn btn-warning mr-1">Oktober</a>
        <br>
        <a href="subcont3november.php" class="btn btn-warning mr-1">November</a>
        <br>
        <a href="subcont3desember.php" class="btn btn-warning mr-1">Desember</a>
    </div>
