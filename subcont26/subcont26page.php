...
<div class="btn-group">
    <a href="subcont26january.php" class="btn btn-warning mr-1">Januari</a>
    <br>
        <a href="subcont26february.php" class="btn btn-warning mr-1">Februari</a>
        <br>
        <a href="subcont26maret.php" class="btn btn-warning mr-1">Maret</a>
        <br>
        <a href="subcont26april.php" class="btn btn-warning mr-1">April</a>
        <br>
        <a href="subcont26mei.php" class="btn btn-warning mr-1">Mei</a>
        <br>
        <a href="subcont26juni.php" class="btn btn-warning mr-1">Juni</a>
        <br>
        <a href="subcont26juli.php" class="btn btn-warning mr-1">Juli</a>
        <br>
        <a href="subcont26agustus.php" class="btn btn-warning mr-1">Agustus</a>
        <br>
        <a href="subcont26september.php" class="btn btn-warning mr-1">September</a>
        <br>
        <a href="subcont26oktober.php" class="btn btn-warning mr-1">Oktober</a>
        <br>
        <a href="subcont26november.php" class="btn btn-warning mr-1">November</a>
        <br>
        <a href="subcont26desember.php" class="btn btn-warning mr-1">Desember</a>
    </div>
