...
<hr>
    ...
    <a href="delivstat.php"><button class="btn btn-primary btn-lg">Back To Delivery</button></a>
    <a href="subcont2page.php"><button class="btn btn-primary btn-lg">Back To Subcont</button></a>
    </div>
    </div>
