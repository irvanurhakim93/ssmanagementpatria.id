...
<div class="btn-group">
    <a href="subcont9january.php" class="btn btn-warning mr-1">Januari</a>
    <br>
        <a href="subcont9february.php" class="btn btn-warning mr-1">Februari</a>
        <br>
        <a href="subcont9maret.php" class="btn btn-warning mr-1">Maret</a>
        <br>
        <a href="subcont9april.php" class="btn btn-warning mr-1">April</a>
        <br>
        <a href="subcont9mei.php" class="btn btn-warning mr-1">Mei</a>
        <br>
        <a href="subcont9juni.php" class="btn btn-warning mr-1">Juni</a>
        <br>
        <a href="subcont9juli.php" class="btn btn-warning mr-1">Juli</a>
        <br>
        <a href="subcont9agustus.php" class="btn btn-warning mr-1">Agustus</a>
        <br>
        <a href="subcont9september.php" class="btn btn-warning mr-1">September</a>
        <br>
        <a href="subcont9oktober.php" class="btn btn-warning mr-1">Oktober</a>
        <br>
        <a href="subcont9november.php" class="btn btn-warning mr-1">November</a>
        <br>
        <a href="subcont9desember.php" class="btn btn-warning mr-1">Desember</a>
    </div>
