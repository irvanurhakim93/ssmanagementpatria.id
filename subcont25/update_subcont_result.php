...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
    <title>Update status subcont result</title>
</head>
<body>
<style type="text/css">
	body{
...
<?php $ambil = $koneksi->query("SELECT * FROM subcont2_pg1 WHERE id='$id_page'");?>
<?php while($perdata = $ambil->fetch_assoc()) {?>
          ...
          <?php 
            ...
            <br>
            <br>
            <h3 style="text-align:center;"><b>Update status subcont result</b></h3>
            <br>
            <br>
          ...
          <tr class="table-row">
              <td>Welder</td>
              <td><?php echo $perdata['welder_permanent']; ?></td>
              <td><?php echo $perdata['welder_contract']; ?></td>
              <td><?php echo $perdata['welder_permanent']; ?></td>
              <td><?php echo $perdata['welder_daily']; ?></td>
              <td><?php echo $perdata['jumlah_karyawan_welder']; ?></td>
            </tr>
            <tr class="table-row">
              <td>Assembler</td>
              <td><?php echo $perdata['assembler_permanent']; ?></td>
              <td><?php echo $perdata['assembler_contract']; ?></td>
              <td><?php echo $perdata['assembler_daily']; ?></td>
              <td><?php echo $perdata['assembler_wholesale']; ?></td>
              <td><?php echo $perdata['jumlah_karyawan_assembler']; ?></td>
            </tr>
            <tr class="table-row">
              <td>Painter</td>
              <td><?php echo $perdata['painter_permanent']; ?></td>
              <td><?php echo $perdata['painter_contract']; ?></td>
              <td><?php echo $perdata['painter_daily']; ?></td>
              <td><?php echo $perdata['painter_wholesale']; ?></td>
              <td><?php echo $perdata['jumlah_karyawan_painter']; ?></td>
            </tr>
            <tr class="table-row">
              <td>QC Inspector</td>
              <td><?php echo $perdata['qc_inspector_permanent']; ?></td>
              <td><?php echo $perdata['qc_inspector_contract']; ?></td>
              <td><?php echo $perdata['qc_inspector_daily']; ?></td>
              <td><?php echo $perdata['qc_inspector_wholesale']; ?></td>
              <td><?php echo $perdata['jumlah_karyawan_qc']; ?></td>
            </tr>
            <tr class="table-row">
              <td>Machining/Forming/PB</td>
              <td><?php echo $perdata['machining_forming_permanent']; ?></td>
              <td><?php echo $perdata['machining_forming_contract']; ?></td>
              <td><?php echo $perdata['machining_forming_daily']; ?></td>
              <td><?php echo $perdata['machining_forming_wholesale']; ?></td>
              <td><?php echo $perdata['jumlah_karyawan_machining']; ?></td>
            </tr>
            <tr class="table-row">
              <td>Engineer</td>
              <td><?php echo $perdata['engineer_permanent']; ?></td>
              <td><?php echo $perdata['engineer_contract']; ?></td>
              <td><?php echo $perdata['engineer_daily']; ?></td>
              <td><?php echo $perdata['engineer_wholesale']; ?></td>
      ...
      <div class="form-inline">
        ...
        <div class="form-inline">
          ...
          <a href="update_subcont_result_excel.php?id=<?php echo $perdata['id']; ?>" class="btn btn-success d-print-none">Konversi Ke Excel</a>
        </div>
