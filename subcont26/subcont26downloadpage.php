    ...
    <ul class="navbar-nav ml-auto">
        <li class="nav-item">
            ...
            <?php if (isset($_SESSION["level"])): ?>
                <li><a href="subcont26page.php" class="btn btn-success btn-sm">Subcont Page</a></li>
                &nbsp;<li><a href="../subcont2/logout.php" class="btn btn-danger btn-sm">Logout</a></li>&nbsp;               
...
<div class="card-body">
   <p>Subcont Page 2</p>
    <a href="subcont_page_2_download_list.php" target="_blank" class="btn btn-success">Unduh Data</a>
</div>
</div>
</div>
<div class="col-4">
...
<div class="card-body">
   <p>Subcont Page 3</p>
    <a href="subcont_page_3_download_list.php" target="_blank" class="btn btn-success">Unduh Data</a>
</div>
</div>
</div>
</div>
