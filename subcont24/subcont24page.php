...
<div class="btn-group">
    <a href="subcont24january.php" class="btn btn-warning mr-1">Januari</a>
    <br>
        <a href="subcont24february.php" class="btn btn-warning mr-1">Februari</a>
        <br>
        <a href="subcont24maret.php" class="btn btn-warning mr-1">Maret</a>
        <br>
        <a href="subcont24april.php" class="btn btn-warning mr-1">April</a>
        <br>
        <a href="subcont24mei.php" class="btn btn-warning mr-1">Mei</a>
        <br>
        <a href="subcont24juni.php" class="btn btn-warning mr-1">Juni</a>
        <br>
        <a href="subcont24juli.php" class="btn btn-warning mr-1">Juli</a>
        <br>
        <a href="subcont24agustus.php" class="btn btn-warning mr-1">Agustus</a>
        <br>
        <a href="subcont24september.php" class="btn btn-warning mr-1">September</a>
        <br>
        <a href="subcont24oktober.php" class="btn btn-warning mr-1">Oktober</a>
        <br>
        <a href="subcont24november.php" class="btn btn-warning mr-1">November</a>
        <br>
        <a href="subcont24desember.php" class="btn btn-warning mr-1">Desember</a>
    </div>
