...
<div class="btn-group">
    <a href="subcont25january.php" class="btn btn-warning mr-1">Januari</a>
    <br>
        <a href="subcont25february.php" class="btn btn-warning mr-1">Februari</a>
        <br>
        <a href="subcont25maret.php" class="btn btn-warning mr-1">Maret</a>
        <br>
        <a href="subcont25april.php" class="btn btn-warning mr-1">April</a>
        <br>
        <a href="subcont25mei.php" class="btn btn-warning mr-1">Mei</a>
        <br>
        <a href="subcont25juni.php" class="btn btn-warning mr-1">Juni</a>
        <br>
        <a href="subcont25juli.php" class="btn btn-warning mr-1">Juli</a>
        <br>
        <a href="subcont25agustus.php" class="btn btn-warning mr-1">Agustus</a>
        <br>
        <a href="subcont25september.php" class="btn btn-warning mr-1">September</a>
        <br>
        <a href="subcont25oktober.php" class="btn btn-warning mr-1">Oktober</a>
        <br>
        <a href="subcont25november.php" class="btn btn-warning mr-1">November</a>
        <br>
        <a href="subcont25desember.php" class="btn btn-warning mr-1">Desember</a>
    </div>
