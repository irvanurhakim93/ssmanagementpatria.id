...
<div class="btn-group">
    <a href="subcont12january.php" class="btn btn-warning mr-1">Januari</a>
    <br>
        <a href="subcont12february.php" class="btn btn-warning mr-1">Februari</a>
        <br>
        <a href="subcont12maret.php" class="btn btn-warning mr-1">Maret</a>
        <br>
        <a href="subcont12april.php" class="btn btn-warning mr-1">April</a>
        <br>
        <a href="subcont12mei.php" class="btn btn-warning mr-1">Mei</a>
        <br>
        <a href="subcont12juni.php" class="btn btn-warning mr-1">Juni</a>
        <br>
        <a href="subcont12juli.php" class="btn btn-warning mr-1">Juli</a>
        <br>
        <a href="subcont12agustus.php" class="btn btn-warning mr-1">Agustus</a>
        <br>
        <a href="subcont12september.php" class="btn btn-warning mr-1">September</a>
        <br>
        <a href="subcont12oktober.php" class="btn btn-warning mr-1">Oktober</a>
        <br>
        <a href="subcont12november.php" class="btn btn-warning mr-1">November</a>
        <br>
        <a href="subcont12desember.php" class="btn btn-warning mr-1">Desember</a>
    </div>
