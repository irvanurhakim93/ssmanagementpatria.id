...
<div class="btn-group">
    <a href="subcont5january.php" class="btn btn-warning mr-1">Januari</a>
    <br>
        <a href="subcont5february.php" class="btn btn-warning mr-1">Februari</a>
        <br>
        <a href="subcont5maret.php" class="btn btn-warning mr-1">Maret</a>
        <br>
        <a href="subcont5april.php" class="btn btn-warning mr-1">April</a>
        <br>
        <a href="subcont5mei.php" class="btn btn-warning mr-1">Mei</a>
        <br>
        <a href="subcont5juni.php" class="btn btn-warning mr-1">Juni</a>
        <br>
        <a href="subcont5juli.php" class="btn btn-warning mr-1">Juli</a>
        <br>
        <a href="subcont5agustus.php" class="btn btn-warning mr-1">Agustus</a>
        <br>
        <a href="subcont5september.php" class="btn btn-warning mr-1">September</a>
        <br>
        <a href="subcont5oktober.php" class="btn btn-warning mr-1">Oktober</a>
        <br>
        <a href="subcont5november.php" class="btn btn-warning mr-1">November</a>
        <br>
        <a href="subcont5desember.php" class="btn btn-warning mr-1">Desember</a>
    </div>
