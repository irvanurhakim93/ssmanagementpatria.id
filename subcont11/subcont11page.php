...
<div class="btn-group">
    <a href="subcont11january.php" class="btn btn-warning mr-1">Januari</a>
    <br>
        <a href="subcont11february.php" class="btn btn-warning mr-1">Februari</a>
        <br>
        <a href="subcont11maret.php" class="btn btn-warning mr-1">Maret</a>
        <br>
        <a href="subcont11april.php" class="btn btn-warning mr-1">April</a>
        <br>
        <a href="subcont11mei.php" class="btn btn-warning mr-1">Mei</a>
        <br>
        <a href="subcont11juni.php" class="btn btn-warning mr-1">Juni</a>
        <br>
        <a href="subcont11juli.php" class="btn btn-warning mr-1">Juli</a>
        <br>
        <a href="subcont11agustus.php" class="btn btn-warning mr-1">Agustus</a>
        <br>
        <a href="subcont11september.php" class="btn btn-warning mr-1">September</a>
        <br>
        <a href="subcont11oktober.php" class="btn btn-warning mr-1">Oktober</a>
        <br>
        <a href="subcont11november.php" class="btn btn-warning mr-1">November</a>
        <br>
        <a href="subcont11desember.php" class="btn btn-warning mr-1">Desember</a>
    </div>
