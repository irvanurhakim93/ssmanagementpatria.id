...
<div class="btn-group">
    <a href="subcont7january.php" class="btn btn-warning mr-1">Januari</a>
    <br>
        <a href="subcont7february.php" class="btn btn-warning mr-1">Februari</a>
        <br>
        <a href="subcont7maret.php" class="btn btn-warning mr-1">Maret</a>
        <br>
        <a href="subcont7april.php" class="btn btn-warning mr-1">April</a>
        <br>
        <a href="subcont7mei.php" class="btn btn-warning mr-1">Mei</a>
        <br>
        <a href="subcont7juni.php" class="btn btn-warning mr-1">Juni</a>
        <br>
        <a href="subcont7juli.php" class="btn btn-warning mr-1">Juli</a>
        <br>
        <a href="subcont7agustus.php" class="btn btn-warning mr-1">Agustus</a>
        <br>
        <a href="subcont7september.php" class="btn btn-warning mr-1">September</a>
        <br>
        <a href="subcont7oktober.php" class="btn btn-warning mr-1">Oktober</a>
        <br>
        <a href="subcont7november.php" class="btn btn-warning mr-1">November</a>
        <br>
        <a href="subcont7desember.php" class="btn btn-warning mr-1">Desember</a>
    </div>
