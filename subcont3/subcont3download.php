    ...
    <ul class="navbar-nav ml-auto">
        <li class="nav-item">
            ...
            <?php if (isset($_SESSION["level"])): ?>
                <li><a href="../subcont3/subcont3page.php" class="btn btn-success btn-sm">Subcont Page</a></li>
                &nbsp;<li><a href="../subcont3/logout.php" class="btn btn-danger btn-sm">Logout</a></li>&nbsp;               
...
<div class="card-body">
    <p>Subcont Page 1</p>
    <a href="subcont_download_page.php" target="_blank" class="btn btn-success">Unduh data</a>
</div>
</div>
</div>
