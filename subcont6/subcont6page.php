...
<div class="btn-group">
    <a href="subcont6january.php" class="btn btn-warning mr-1">Januari</a>
    <br>
        <a href="subcont6february.php" class="btn btn-warning mr-1">Februari</a>
        <br>
        <a href="subcont6maret.php" class="btn btn-warning mr-1">Maret</a>
        <br>
        <a href="subcont6april.php" class="btn btn-warning mr-1">April</a>
        <br>
        <a href="subcont6mei.php" class="btn btn-warning mr-1">Mei</a>
        <br>
        <a href="subcont6juni.php" class="btn btn-warning mr-1">Juni</a>
        <br>
        <a href="subcont6juli.php" class="btn btn-warning mr-1">Juli</a>
        <br>
        <a href="subcont6agustus.php" class="btn btn-warning mr-1">Agustus</a>
        <br>
        <a href="subcont6september.php" class="btn btn-warning mr-1">September</a>
        <br>
        <a href="subcont6oktober.php" class="btn btn-warning mr-1">Oktober</a>
        <br>
        <a href="subcont6november.php" class="btn btn-warning mr-1">November</a>
        <br>
        <a href="subcont6desember.php" class="btn btn-warning mr-1">Desember</a>
    </div>
