...
<div class="container">
    ...
    <div class="container">
        <div class="row">
            <?php $ambil = $koneksi->query("SELECT * FROM subcont222_pg1"); ?>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><a href="update_subcont_result.php?id=<?php echo $subcontpg1['id']; ?>" class="btn btn-success"><i class="fa fa-download"></i></a></td>
                        </tr>
                    </tbody>
                </table>
            </div>
