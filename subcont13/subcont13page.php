...
<div class="btn-group">
    <a href="subcont13january.php" class="btn btn-warning mr-1">Januari</a>
    <br>
        <a href="subcont13february.php" class="btn btn-warning mr-1">Februari</a>
        <br>
        <a href="subcont13maret.php" class="btn btn-warning mr-1">Maret</a>
        <br>
        <a href="subcont13april.php" class="btn btn-warning mr-1">April</a>
        <br>
        <a href="subcont13mei.php" class="btn btn-warning mr-1">Mei</a>
        <br>
        <a href="subcont13juni.php" class="btn btn-warning mr-1">Juni</a>
        <br>
        <a href="subcont13juli.php" class="btn btn-warning mr-1">Juli</a>
        <br>
        <a href="subcont13agustus.php" class="btn btn-warning mr-1">Agustus</a>
        <br>
        <a href="subcont13september.php" class="btn btn-warning mr-1">September</a>
        <br>
        <a href="subcont13oktober.php" class="btn btn-warning mr-1">Oktober</a>
        <br>
        <a href="subcont13november.php" class="btn btn-warning mr-1">November</a>
        <br>
        <a href="subcont13desember.php" class="btn btn-warning mr-1">Desember</a>
    </div>
